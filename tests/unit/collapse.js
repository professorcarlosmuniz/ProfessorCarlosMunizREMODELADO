$(function () {
  ...
  QUnit.test('should show multiple collapsed elements', function (assert) {
    assert.expect(4)
    var done = assert.async()
    var $target = $('<a role="button" data-toggle="collapse" class="collapsed" href="../../bootstrap-4.5.3/js/tests/unit/.multi"/>').appendTo('#qunit-fixture')
  ...
  QUnit.test('should add "collapsed" class to triggers only when all the targeted collapse are hidden', function (assert) {
    ...
    var $trigger3 = $('<a role="button" data-toggle="collapse" href="../../bootstrap-4.5.3/js/tests/unit/.multi"/>').appendTo('#qunit-fixture')
